...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/axkami/dwo/main/1/password"
...
# Edu OVPN
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/axkami/dwo/main/1/edu-ovpn.py
...
#edussh
wget -q -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/axkami/dwo/main/1/dropbear-ws.py
...
#edusshssl
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/axkami/dwo/main/1/ws-stunnel
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/axkami/dwo/main/1/nginx.conf"
mkdir -p /home/vps/public_html
echo "<h1><center>AutoScriptVPS By Brody</center></h1>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/axkami/dwo/main/1/vps.conf"
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/axkami/dwo/main/1/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/axkami/dwo/main/1/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/axkami/dwo/main/1/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/axkami/dwo/main/1/banner.conf"
